-- =========================================================================
-- COPY EVERYTHING IN THIS FILE INTO YOUR SUPABASE SQL EDITOR AND CLICK RUN
-- Dashboard: https://supabase.com/dashboard/project/hoqtyaebrfcsjlwbonts/sql/new
-- This installs the chatbot knowledge base + the teacher/student portal schema.
-- =========================================================================

-- Chatbot knowledge base â€” admin-editable Q&A snippets the chatbot retrieves
...
insert into chatbot_knowledge (topic, question, answer, sort_order) values
  ('Pricing',    'How much do courses cost?',          'Course prices vary by program and group size. Please share your contact and we''ll send our full price list â€” or call us at +963 17 2566699.', 1),
  ...
  ('Levels',     'How do you determine my level?',     'You can take our free AI Assessment on the homepage (25 multiple-choice + read-aloud + writing) â€” you''ll get a CEFR level and we can place you in the right class.', 3),
  ('Online',     'Do you offer online classes?',       'Yes â€” live online classes with the same instructors and curriculum as in-center. Great for students abroad and busy professionals.', 4),
  ('Location',   'Where are you located?',             'We''re in Latakia, Syria â€” Omar Ibn Al-Khattab Street (Al-Quwatli area). We''re open Saturday to Thursday, 9am to 9pm.', 5),
  ...
  ('Booking',    'How do I book an assessment?',       'Use the "Book a personal assessment" form on the homepage â€” pick three preferred slots and we''ll confirm one within 24 business hours by email and WhatsApp.', 8),
  ('Kids',       'Do you teach kids?',                 'Yes â€” our Kids & Teens program is for ages 7 to 17, with separate age cohorts and a curriculum built around games, stories, and group activities.', 9),
  ('Exam Prep',  'Do you prepare for IELTS / TOEFL?',  'Yes â€” intensive TOEFL & IELTS prep with weekly mock exams, time-management training, and specialised strategies for each section. Many of our students score 7.0+ IELTS.', 10);


-- ===== Portals schema =====

-- =========================================================================
-- Phase 2: Teacher + Student portals â€” schema, roles, RLS
-- =========================================================================
...
insert into book_library (title, author, description, language, level, cover_url, pdf_url, is_public, sort_order) values
  ('Common English Idioms â€” A Pocket Guide', 'Rai Language Center', 'A short illustrated reference for everyday idioms with example dialogues.', 'en', 'B1', null, '/sample-books/idioms.pdf', true, 1),
  ('IELTS Speaking â€” 30 Practice Topics',    'Rai Language Center', 'Practice prompts with model answers and useful phrases.',               'en', 'B2', null, '/sample-books/ielts-speaking.pdf', true, 2),
  ('Business English â€” Email Templates',      'Rai Language Center', '20 ready-to-adapt email templates for the modern workplace.',             'en', 'B2', null, '/sample-books/business-emails.pdf', true, 3)
